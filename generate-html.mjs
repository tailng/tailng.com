...
const START_MARKER = "<!-- tailng top section -->";
const END_MARKER = "<!-- tailng bottom section -->";

const TITLE_TOKEN = "<!-- tailng-page-title -->";
const DESC_TOKEN = "<!-- tailng-page-description -->";

const SKIP_DIRS = new Set(["node_modules", ".git", "dist", ".cache", ".vercel"]);
